            ...
            <div className="flex flex-row">
              <MemoizedReactMarkdown
                ...
                components={{
                  ...
                  th({ children }) {
                    return (
                      <th className="break-words border border-black bg-gray-500 px-3 py-1 text-[#706233] dark:text-[#706233] dark:border-white">
                        {children}
                      </th>
                    );
                  },
                  td({ children }) {
                    return (
                      <td className="break-words border border-black px-3 py-1 text-[#706233] dark:border-white">
                        {children}
                      </td>
                    );
                  },
